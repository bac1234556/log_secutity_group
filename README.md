...
1.  **Data Collection:** Sử dụng tập dữ liệu mạng IoT tiêu chuẩn: *CICIoT2023* .
...
* [x] Lên ý tưởng và xác định kiến trúc hệ thống.
* [x] Khởi tạo Repository và setup môi trường.
